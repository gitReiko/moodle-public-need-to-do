...
$string['categories_not_exist'] = 'Не существует ни одной категории курсов. Создайте категорию курсов, чтобы использовать эту настройку.';
$string['cohort_not_exist'] = 'Не существует ни одной группы. Создайте глобальную группу, чтобы использовать эту настройку.';
$string['config_local_cohort_help'] = 'Блок будет работать только с преподавателями из выбранной глобальной группы. Если выбранная в блоке глобальная группа не существует, то будет использоваться глобальная настройка блока.';
$string['config_local_cohort'] = 'Работать с глобальной группой';
$string['config_local_course_category_help'] = 'Блок будет работать только с курсами из выбранной категории.';
$string['config_local_course_category'] = 'Работать с категорией курсов';
$string['course_activities'] = 'Активности курса';
$string['course'] = 'Курс: ';
$string['coursework_desc'] = 'Это модуль, который позволяет выполнять курсовые работы. По умолчанию он отключен. Если модуль курсовых работ не установлен, он не будет обрабатываться даже, если эта настройка включена.';
...
$string['messages_not_read_in_chat'] = 'Непрочитанные сообщения чата';
...
$string['needtodo:monitorteachersincourse'] = 'Контроль за работой учителей в курсе';
...
$string['pluginname:myaddinstance'] = 'Добавить новый блок Нужно сделать на страницу Личного кабинета';
$string['pluginname'] = 'Нужно сделать';
$string['quiz_desc'] = 'Мониторинг проверки работ в активностях типа Тест.';
$string['quiz'] = 'Тест';
$string['show_more'] = 'Показать больше...';
$string['site_messenger_desc'] = 'Это мессенджер, который доступен по всему сайту. Обычно он находится в правой части заголовка сайта.';
$string['site_messenger'] = 'Мессенджер сайта';
...
$string['untimely_unchecked_works'] = 'Несвоевременно проверено работ: ';
$string['untimely_unread_messages'] = 'Несвоевременно прочитано сообщений: ';
$string['update_data'] = 'Обновить данные';
$string['use_settings_below'] = 'Использовать приведённые ниже настройки';
$string['working_past_days_tool'] = 'Эта настройка определяет количество дней, с которыми работает блок. Данные, старейшие за определённую дату, не учитываются.';
